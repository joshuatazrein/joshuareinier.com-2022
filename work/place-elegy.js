...
export default function PlaceElegy({}) {
  return (
    <>
      <Title title={title} background="/img/place-elegy_cover.webp"></Title>

      <Explanation>
        <i>place elegy</i> contemplates the self-referential nature of "places:"
        we co-create them, endow them with significance through what we think
        others perceive. Similarly, our images of ourselves are formed in large
        part through mirrors from others and the outer world—identity is created
        fundamentally from surface. The poem uses a set of repeated words that
        cycle through its five stanzas, a language of echoes that never settle.
        The sound portion explores this unsettledness through paralanguage, as
        the central speaker is surrounded with inarticulate spectres
        reverberating the labor of breath.
      </Explanation>
