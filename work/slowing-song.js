...
export default function SlowingSong({}) {
  return (
    <>
      ...
      <Explanation>
        ...
        piece to drag out these repetitions in a spiralling descent: movement I
        is metered and energetic, while mvt. II begins stretching time through
        the use of proportional notation, culminating in the meterless mvt. III.
        The ensemble is treated as a giant mouth uttering the poem's guttural,
        sonic qualities which gradually bubble up from the depths.
      </Explanation>
      <Explanation>
